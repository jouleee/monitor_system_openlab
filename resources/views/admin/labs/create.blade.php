...
@section('title', 'Tambah Laboratorium - Admin Dashboard')
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <p class="lead mb-0">Tambahkan laboratorium baru ke sistem monitoring</p>
            </div>
                    ...
                    <form action="{{ route('admin.labs.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <label for="status_id" class="form-label fw-semibold">
                                    <i class="fas fa-circle me-2"></i>Status Awal
                                </label>
                        ...
                        <div class="text-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Simpan Laboratorium
                            </button>
                        </div>
                    </form>
                </div>
